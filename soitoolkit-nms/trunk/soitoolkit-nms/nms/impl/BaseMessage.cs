...
{
    internal class BaseMessage : IBaseMessage
    {
        ...
        public BaseMessage() : this(null) { }

        public BaseMessage(Dictionary<string, string> CustomHeaders)
        {
            this.CustomHeaders = CustomHeaders;
        }

        internal void AddHeadersToBaseMessage(IMessage nmsMsg)
        {
